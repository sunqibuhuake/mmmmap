...
function rotateMap() {
    ...
    if(plane.rotation.z == 0) {
        ...
        if(textLayer) {
            textLayer.rotation.z = Math.PI / 2
    ...
    $(function() {
        ...
        $('.newBtn').click(function() {
            ...
            if(showSmallMap) {
                ...
                $('.address_input').removeAttr('disabled')
            } else {
                showSmallMap = true
                $('.address_input').attr('disabled', 'disabled')
                if(mode == 'IMAGE') {
                    $('#smallmap').attr('src', './image-map-small.png')
                    $('#smallmap').css({
                        display: 'block'
                    })
                } else {
                    $('#smallmap').attr('src', './text-map-small.png')
                    $('#smallmap').css({
                        display: 'block'
                    })
                }
